...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 197 93" }, props),
        React.createElement("image", { width: 197, height: 93, href: "/images/egg/9.png" })));
};
...
var Icon$I = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M4.22 13.383L12.849 2.39c.62-.79 1.887-.275 1.78.723L14 9h5.004a1 1 0 01.787 1.618L11.15 21.62c-.62.79-1.887.275-1.78-.724L10 15H5.006a1 1 0 01-.786-1.617z" })));
};
...
var Icon$T = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M21 9a1 1 0 00-1-1h-1c0-.988-.013-1.506-.218-1.908a2 2 0 00-.874-.874c-.402-.205-.92-.217-1.908-.218V4a1 1 0 10-2 0v1h-4V4a1 1 0 00-2 0v1c-.988 0-1.506.013-1.908.218a2 2 0 00-.874.874C5.013 6.494 5.001 7.012 5 8H4a1 1 0 100 2h1v4H4a1 1 0 100 2h1c0 .988.013 1.506.218 1.908a2 2 0 00.874.874c.402.205.92.217 1.908.218v1a1 1 0 102 0v-1h4v1a1 1 0 102 0v-1c.988 0 1.506-.013 1.908-.218a2 2 0 00.874-.874c.205-.402.217-.92.218-1.908h1a1 1 0 100-2h-1v-4h1a1 1 0 001-1zm-10 1a1 1 0 00-1 1v2a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 00-1-1h-2z" })));
};

var Icon$U = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M9 14a5 5 0 00-5 5 3 3 0 003 3h10a3 3 0 003-3 5 5 0 00-5-5H9zM12 2a5 5 0 100 10 5 5 0 000-10z" })));
};

var Icon$V = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M10.609 2.938c.505-1.252 2.277-1.252 2.782 0l1.937 4.802a.5.5 0 00.423.311l4.867.397c1.319.108 1.862 1.747.868 2.622l-3.692 3.247a.5.5 0 00-.159.483l1.181 5.367c.295 1.341-1.216 2.34-2.335 1.544l-4.191-2.984a.5.5 0 00-.58 0l-4.191 2.985c-1.119.796-2.63-.204-2.335-1.545l1.18-5.367a.5.5 0 00-.158-.483L2.514 11.07c-.994-.875-.451-2.514.868-2.622l4.867-.397a.5.5 0 00.423-.311l1.937-4.802z" })));
};
...
var Icon$Z = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M3 14.5a6.5 6.5 0 1013 0 6.5 6.5 0 00-13 0z" }),
        React.createElement("path", { d: "M9.29 5.613c-.122.163.007.387.21.387a8.5 8.5 0 018.5 8.5c0 .204.224.332.387.21A6.5 6.5 0 109.29 5.613z" })));
};
...
var Icon$10 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M6 11a3 3 0 100-6 3 3 0 000 6zm3 10a4 4 0 100-8 4 4 0 000 8z" }),
        React.createElement("path", { d: "M21 8a5 5 0 11-10 0 5 5 0 0110 0z" })));
};
